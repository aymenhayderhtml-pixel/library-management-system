...
export declare function parseCliUserModelId(modelId: string): {
    provider: CliProvider;
    model: string | null;
};
export declare function parseCliProviderArg(raw: string): CliProvider;
export declare function parseBooleanEnv(value: string | null | undefined): boolean | null;
export {};
