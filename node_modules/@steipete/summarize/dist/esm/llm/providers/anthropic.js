...
export function normalizeAnthropicModelAccessError(error, modelId) {
    if (!error || typeof error !== "object")
        return null;
    const maybe = error;
...
export async function completeAnthropicText({ modelId, apiKey, context, temperature, maxOutputTokens, signal, anthropicBaseUrlOverride, }) {
...
export async function completeAnthropicDocument({ modelId, apiKey, promptText, document, system, maxOutputTokens, timeoutMs, fetchImpl, anthropicBaseUrlOverride, }) {
