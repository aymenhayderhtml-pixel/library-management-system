...
export async function completeGoogleText({ modelId, apiKey, context, temperature, maxOutputTokens, signal, googleBaseUrlOverride, }) {
...
export async function completeGoogleDocument({ modelId, apiKey, promptText, document, maxOutputTokens, temperature, timeoutMs, fetchImpl, googleBaseUrlOverride, }) {
    if (document.kind !== "document") {
        throw new Error("Internal error: expected a document attachment for Google.");
    }
    const baseUrl = resolveBaseUrlOverride(googleBaseUrlOverride) ??
