...
export function resolveOpenAiModel({ modelId, context, openaiConfig, }) {
...
export function resolveZaiModel({ modelId, context, openaiBaseUrlOverride, }) {
    const allowImages = wantsImages(context);
...
export function resolveXaiModel({ modelId, context, xaiBaseUrlOverride, }) {
    const allowImages = wantsImages(context);
...
export function resolveGoogleModel({ modelId, context, googleBaseUrlOverride, }) {
    const allowImages = wantsImages(context);
...
export function resolveAnthropicModel({ modelId, context, anthropicBaseUrlOverride, }) {
    const allowImages = wantsImages(context);
