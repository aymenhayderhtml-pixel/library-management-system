...
function buildTranscriptToMarkdownPrompt({ title, source, transcript, outputLanguage, }) {
...
export function createTranscriptToMarkdownConverter({ modelId, forceOpenRouter, xaiApiKey, googleApiKey, openaiApiKey, openaiBaseUrlOverride, anthropicBaseUrlOverride, googleBaseUrlOverride, xaiBaseUrlOverride, anthropicApiKey, openrouterApiKey, fetchImpl, forceChatCompletions, retries = 0, onRetry, onUsage, }) {
    return async ({ title, source, transcript, timeoutMs, outputLanguage }) => {
        const trimmedTranscript = transcript.length > MAX_TRANSCRIPT_INPUT_CHARACTERS
...
//# sourceMappingURL=transcript-to-markdown.js.map