...
export function buildProgram() {
    return new Command()
        ...
        .addOption(new Option("--cli [provider]", "Use a CLI provider: claude, gemini, codex, agent (equivalent to --model cli/<provider>). If omitted, use auto selection with CLI enabled."))
