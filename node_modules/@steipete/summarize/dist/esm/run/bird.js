...
const isLikelyVideoUrl = (url) => url.includes("video.twimg.com") || url.includes("/i/broadcasts/") || url.endsWith(".m3u8");
...
function extractMediaFromBirdRaw(raw) {
...
export async function readTweetWithBird(args) {
    return await new Promise((resolve, reject) => {
        const toText = (value) => typeof value === "string" ? value : value ? value.toString("utf8") : "";
        execFileTracked("bird", ["read", args.url, "--json-full"], {
...
export function withBirdTip(error, url, env) {
