...
export function resolveCliAvailability({ env, config, }) {
    ...
    const providers = ["claude", "codex", "gemini", "agent"];
    const availability = {};
