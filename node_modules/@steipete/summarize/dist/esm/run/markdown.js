function materializeInlineMarkdownLinks(markdown) {
    ...
    for (const line of lines) {
        ...
        out.push(line.replace(/(?<!!)\[([^\]]+)\]\((\S+?)\)/g, (_full, label, url) => {
...
export function prepareMarkdownLineForTerminal(line) {
...
export function prepareMarkdownForTerminalStreaming(markdown) {
...
export function prepareMarkdownForTerminal(markdown) {
    return collapseExtraBlankLines(materializeInlineMarkdownLinks(inlineReferenceStyleLinks(markdown)));
}
