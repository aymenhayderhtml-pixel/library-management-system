export function createStreamOutputGate({ stdout, clearProgressForStdout, restoreProgressAfterStdout, outputMode, richTty, }) {
    let cleared = false;
    ...
    const handleChunk = (streamed, prevStreamed) => {
