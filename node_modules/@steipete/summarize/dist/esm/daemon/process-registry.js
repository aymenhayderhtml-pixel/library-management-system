...
export class ProcessRegistry {
    ...
    getLogs(id, opts) {
        ...
        const lines = stream === "stdout"
            ? record.stdout.slice(-tail).map((line) => ({ stream: "stdout", line }))
            : stream === "stderr"
                ? record.stderr.slice(-tail).map((line) => ({ stream: "stderr", line }))
    ...
    register(info) {
        ...
        return {
            ...
            appendOutput: (stream, line) => {
                ...
                const entry = { stream, line: cleaned };
...
export function buildProcessListResult(registry, opts) {
    return registry.list(opts);
}
export function buildProcessLogsResult(registry, id, opts) {
    return registry.getLogs(id, opts);
}
function normalizeLine(line, maxLength) {
