...
export async function streamChatResponse({ env, fetchImpl, session: _session, pageUrl, pageTitle, pageContent, messages, modelOverride, pushToSession, emitMeta, }) {
    ...
    const attempt = attempts.find((entry) => entry.transport !== "cli" &&
        entry.llmModelId &&
