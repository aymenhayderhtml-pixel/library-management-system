...
export function createTranscriptProgressRenderer({ spinner, oscProgress, theme, }) {
    ...
    const formatProvider = (hint) => {
        ...
        if (hint === "groq")
            return "Whisper/Groq";
        if (hint === "groq->openai")
            return "Whisper/Groq→OpenAI";
        if (hint === "groq->fal")
            return "Whisper/Groq→FAL";
        if (hint === "groq->openai->fal")
            return "Whisper/Groq→OpenAI→FAL";
        if (hint === "openai")
