export const CLI_THEME_NAMES = ["aurora", "ember", "moss", "mono"];
const THEMES = {
    aurora: {
        name: "aurora",
        roles: {
...
export const DEFAULT_CLI_THEME = "aurora";
export function listCliThemes() {
    return [...CLI_THEME_NAMES];
}
export function isCliThemeName(value) {
    return CLI_THEME_NAMES.includes(value);
}
export function parseCliThemeName(raw, label) {
...
export function resolveThemeNameFromSources({ cli, env, config, fallback = DEFAULT_CLI_THEME, }) {
...
export function resolveTrueColor(env) {
...
export function resolveThemePalette(themeName) {
