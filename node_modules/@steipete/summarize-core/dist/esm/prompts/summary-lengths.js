...
export const SUMMARY_LENGTH_TO_TOKENS = Object.fromEntries(Object.entries(SUMMARY_LENGTH_SPECS).map(([key, spec]) => [key, spec.maxTokens]));
export const SUMMARY_LENGTH_TARGET_CHARACTERS = Object.fromEntries(Object.entries(SUMMARY_LENGTH_SPECS).map(([key, spec]) => [key, spec.targetCharacters]));
export const SUMMARY_LENGTH_MAX_CHARACTERS = Object.fromEntries(Object.entries(SUMMARY_LENGTH_SPECS).map(([key, spec]) => [key, spec.maxCharacters]));
export function resolveSummaryLengthSpec(length) {
...
export function formatPresetLengthGuidance(length) {
...
//# sourceMappingURL=summary-lengths.js.map