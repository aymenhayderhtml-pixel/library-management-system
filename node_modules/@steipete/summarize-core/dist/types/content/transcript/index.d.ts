...
export declare const resolveTranscriptForLink: (url: string, html: string | null, deps: LinkPreviewDeps, { youtubeTranscriptMode, mediaTranscriptMode, mediaKindHint, transcriptTimestamps, cacheMode: providedCacheMode, fileMtime, }?: ResolveTranscriptOptions) => Promise<TranscriptResolution>;
export {};
